...
const whoCanAttend = [
  ...
  "Corporate leaders, managers, and HR professionals",
  "Policy practitioners and civil services aspirants",
  "Armed forces, police, and other uniformed services personnel",
  "Entrepreneurs, founders, and business owners",
  "Consultants, trainers, and leadership coaches",
  "Researchers and students of management, public policy, governance, and law",
  "Professionals seeking ethical clarity in leadership and decision-making",
];
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <SectionReveal>
              <div className="max-w-4xl mx-auto space-y-6 text-muted-foreground leading-[1.9] text-base lg:text-lg">
                <p>
                  The Executive Program in Leadership, Public Policy and Global Governance equips leaders to navigate complex global governance and policy challenges with strategic vision and ethical insight. The program integrates leadership, public policy, and India's governance traditions to develop skills in decision-making, collaboration, crisis management, and effective communication, preparing participants to lead organizations, institutions, and governments in a rapidly changing world.
                </p>
                <p>
                  Drawing inspiration from classical texts such as the Ramayana and leadership ideals exemplified by Lord Rama, the course provides a unique Indian perspective on responsible governance, institutional leadership, and sustainable policy innovation.
                </p>
              </div>
            </SectionReveal>
          </div>
            ...
            <div className="max-w-5xl mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <SectionReveal delay={100}>
                <div className="rounded-xl border border-border bg-card p-7 shadow-sm h-full">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Case discussion → Policy dilemma → Group debate → Modern application → Framework extraction
                  </p>
                </div>
              </SectionReveal>
              <SectionReveal delay={200}>
                <div className="rounded-xl border border-border bg-card p-7 shadow-sm h-full">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Upon completion, participants will strengthen their capacity to address complex public policy challenges and evolving global governance systems through strategic leadership and ethical decision-making, with a global outlook on policy innovation, institutional stewardship, and multilateral cooperation.
                  </p>
                </div>
              </SectionReveal>
              ...
              <SectionReveal delay={400}>
                <div className="rounded-xl border border-border bg-card p-7 shadow-sm h-full">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Founding Cohort | Limited Seats | Invitation & Application-Based Selection
                  </p>
              ...
              <SectionReveal delay={500}>
                <div className="rounded-xl border border-border bg-card p-7 shadow-sm h-full">
                  ...
                  <div className="text-sm text-muted-foreground leading-relaxed space-y-1">
                    <p><strong>Cohort 1</strong> – September/October 2026 — Applications Open</p>
                    <p><strong>Cohort 2</strong> – February/March 2027 — Advance Expressions of Interest Invited</p>
                  </div>
                </div>
              </SectionReveal>
            </div>
